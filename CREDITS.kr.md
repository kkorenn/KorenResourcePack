...
혹시 기여하셨는데 이름이 누락되었다면, 이슈를 열거나 연락해 주시면 추가해드리겠습니다.
...
이 프로젝트는 다음 프로젝트들로부터 영감을 받아 개발되었습니다:
...
이 프로젝트는 위 들의 코드 또는 아이디어에서 영향을 받았을 수 있습니다.
자세한 라이선스 정보는 각 리포지토리를 참고해 주세요.

## 라이선스

이 프로젝트는 Unlicense 라이선스를 따릅니다. 자세한 내용은 [LICENSE](LICENSE) 파일을 참고해 주세요.

## 폰트

이 프로젝트에서 사용된 모든 폰트는 각자의 라이선스를 따릅니다.
자세한 내용은 해당 폰트의 원본 출처를 참고해 주세요.
